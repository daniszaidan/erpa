  ...
  (
    ...
    const buttonContent = (
      <button
        ref={ref}
        className={cn(
          'group transition-all duration-300 h-[45px] rounded-full flex items-center justify-between gap-10 relative overflow-hidden w-full cursor-pointer bg-white/60 hover:bg-white/90 backdrop-blur-[30px] pl-15 pr-[7.5px]',
          className
        )}
        aria-label={title}
        {...props}
